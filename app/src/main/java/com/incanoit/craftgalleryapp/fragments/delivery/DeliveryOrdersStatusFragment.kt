package com.incanoit.craftgalleryapp.fragments.delivery
...
import com.incanoit.craftgalleryapp.adapters.OrdersDeliveryAdapater
...
class DeliveryOrdersStatusFragment : Fragment() {
    ...
    var adapter: OrdersDeliveryAdapater?=null
    var status=""
        ...
        ordersProvider?.getOrdersByDeliveryAndStatus(user?.id!!,status)?.enqueue(object: Callback<ArrayList<Order>>{
            override fun onResponse(
                ...
                if (response.body()!=null){
                    ...
                    adapter = OrdersDeliveryAdapater(requireActivity(),orders!!)

...
class ArtezanoRegisterActivity : AppCompatActivity() {
    ...
    var editTextYears: EditText?=null
    var editTextRNA: EditText?=null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_artezano_register)
        ...
        editTextYears=findViewById(R.id.edittext_years)
        editTextRNA=findViewById(R.id.edittext_rna)
    ...
    private fun goToRegister(){
        ...
        val rna = editTextRNA?.text.toString()
        val password = editTextPassword?.text.toString()
        val confirm_password = editTextPasswordConfirm?.text.toString()
        if (isValidForm(name,lastname,dni,phone,fecha_nac,years,rna,email,password,confirm_password)){
            val user = User(
                name = name,
                lastname = lastname,
                phone = phone,
            ...
            userProvider.register(user)?.enqueue(object: Callback<ResponseHttp>{
                ...
                override fun onResponse(
                    ...
                    Toast.makeText(this@ArtezanoRegisterActivity, response.body()?.message, Toast.LENGTH_LONG).show()
                ...
                override fun onFailure(call: Call<ResponseHttp>, t: Throwable) {
                    ...
                    Toast.makeText(this@ArtezanoRegisterActivity, "Se produjo un error ${t.message}", Toast.LENGTH_LONG).show()
                }
    ...
    private fun isValidForm(
        ...
        if (years.isBlank()){
            Toast.makeText(this, "los años en el mercado son importantes", Toast.LENGTH_SHORT).show()
            return false
        }
        if (rna.isBlank()){
            Toast.makeText(this, "Debe registrar el codigo RNA", Toast.LENGTH_SHORT).show()
            return false
        }
        if (password.isBlank()){

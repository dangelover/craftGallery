...
class RepartidorRegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_repartidor_register)
    ...
    private fun goToRegister(){
        ...
        if (isValidForm(name,lastname,dni,phone,fecha_nac,years,email,password,confirm_password)){
            val user = User(
                name = name,
                lastname = lastname,
                phone = phone,
            ...
            userProvider.register(user)?.enqueue(object: Callback<ResponseHttp>{
                ...
                override fun onResponse(
                    ...
                    Toast.makeText(this@RepartidorRegisterActivity, response.body()?.message, Toast.LENGTH_LONG).show()
                ...
                override fun onFailure(call: Call<ResponseHttp>, t: Throwable) {
                    ...
                    Toast.makeText(this@RepartidorRegisterActivity, "Se produjo un error ${t.message}", Toast.LENGTH_LONG).show()
                }
